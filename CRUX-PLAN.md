...
> **State as of 2026-08-20: crux is v1.1.0. All seven phases are done, every track is built, chain mode threads them into one engagement, and the launch opens on an animated signal-scope splash.** It lives at `~/projects/crux`, outside the Obsidian vault, same as `waypoint` and `hone`, and it is its own git repository.
>
