...
> **State as of 2026-08-20: Phase 2 is complete. The `sift` track is done.** It lives at `~/projects/crux`, outside the Obsidian vault, same as `waypoint` and `hone`, and it is its own git repository.
>
...
>
> **Next action: Phase 3, the salvage engine.** `mockhttp.py`, `mocktcp.py`, the hit-record interface, the edit-and-run loop, and defect classes 1 to 5. Nothing in sift is blocking or half-finished.
>
