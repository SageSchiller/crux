...
> **State as of 2026-08-20: Phase 5 is complete. All three tracks run, and conduit is `verified`.** It lives at `~/projects/crux`, outside the Obsidian vault, same as `waypoint` and `hone`, and it is its own git repository.
>
...
>
> **Next action: Phase 6, conduit content**, topologies 3 to 7. Two are authored (`-L` and a socat relay) and the engine takes a new topology as data, so each further one is content rather than engineering.
>
